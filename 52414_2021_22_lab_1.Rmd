...
# a. Loading the data:
df <- read.csv("C:\\Users\\halitcohen\\Documents\\GitHub\\r52414_2021_22_lab1-Mauda_Yoray_and_Cohen_Halit\\owid-covid-data.csv")
...
# This is the plot that works OUTSIDE the func. Now we need it to work INSIDE!
ggplot(filtered_covid_data_high, aes(date, new_deaths)) + geom_point() +
